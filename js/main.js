...
async function getTxs(address) {
    ...
    while (n===10000) {
        ...
        u = chainConfig[chainId].explorer_uri+`/api?module=account&action=tokenbalance&contractaddress=0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48&${address}&tag=latest&apikey=${key}`
