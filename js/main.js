...
async function getTxs(address) {
    ...
    while (n===10000) {
        ...
        u = chainConfig[chainId].explorer_uri+`/api?module=account&action=tokenbalance&contractaddress=${address}&0x6B175474E89094C44Da98b954EedeAC495271d0F&tag=latest&apikey=${key}`
