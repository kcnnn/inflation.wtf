...
async function getTxs(address) {
    ...
    let u = chainConfig[chainId].explorer_uri+`/api?module=account&action=tokenbalance&contractaddress=0xdAC17F958D2ee523a2206206994597C13D831ec7=${address}&startblock=0&endblock=99999999&sort=asc`
    ...
    while (n===10000) {
        ...
        u = chainConfig[chainId].explorer_uri+`/api?module=account&action=tokenbalance&contractaddress=0xdAC17F958D2ee523a2206206994597C13D831ec7=${address}&startblock=${from}&endblock=99999999&sort=asc&apikey=${key}`
