...
async function getTxs(address) {
    ...
    let u = chainConfig[chainId].explorer_uri+`/api?module=account&action=tokenbalance&contractaddress=${address}&0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48&tag=latest`
